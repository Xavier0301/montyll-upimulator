...
u32 unif_rand_range_u32_except(u32 min, u32 max, u32 except) {
    u32 pick;
    do {
        pick = unif_rand_range_u32(min, max);
    } while(pick == except);
...
SHUFFLE_ARRAY_IMPLEMENTATION(u32)
SHUFFLE_ARRAY_IMPLEMENTATION(u16)
SHUFFLE_ARRAY_IMPLEMENTATION(u8)
